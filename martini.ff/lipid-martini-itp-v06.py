...
__version__ = "0.6"
__email__   = "ingolfsson@gmail.com"
...
definitions, lipids with these topologies have been explore e.g. in:
 ...
 -T.A. Vuorela, A. Catte, P.S. Niemela, A. Hall, M.T. Hyvonen, S.J. Marrink, M. Karttunen,
  I. Vattulainen. Role of lipids in spheroidal high density lipoproteins. PLoS Comp Biol,
  6:e1000964, 2010.
 -New Martini PIP paper - Carlos 2017-2018 TBA
...
WARNING:
  ...
  - We have not finished testing of the new PIP topologies and the final parameters might still change.
...
Heads (-alhead):
  ...
  head bead types supported:
    ...
    PI = phosphatidylinositol - x4 beads, charge -1
    P1 = PIP_1(3)             - x5 beads, charge -3
    P2 = PIP_2(3,4)           - x6 beads, charge -5
    P3 = PIP_3(3,4,5)         - x7 beads, charge -7
    P4 = PIP_1(4)             - x5 beads, charge -3
    P5 = PIP_1(5)             - x5 beads, charge -3
    P6 = PIP_2(4,5)           - x6 beads, charge -5
    P7 = PIP_2(3,4)           - x6 beads, charge -5
  ...
  Current version also supports writing phosphatidylinositol phosphate headgrous (called
  PI, P1, P2, P3, P4, P5, P6, and P7). These headgroups are hardcoded based on parameters
  from Carlos et al. TBA 2017-2018 and Lopez et al. 2013 JCTC.

Linkers (-allink):
  Currently only lipids with Glycerol linker or sphingosine backbone are supported. Each
...
Use:
  ./lipid-martini-itp-v06.py -alhead 'C P' -allink 'G G' -altail "CDCC CCCC" -alname POPC -o POPC-lipid.itp
"""
...
if len(headsArray)>0 and headsArray[0]=='PI': # Add PI head
    # This is from the head of PI Cesars DPPI parameaters (in the glycolipids.itp)
    # Modified: - bead 4 CP name changed to PO4 - HII
    # Modified: - switch on / of constraints - Helgi, Xavier
    # Modified: - see Carlos 2017 Martini PIP paper
    ...
    anglesArray.append([3, 1, 4, '133.0', '100.0', '; Not used in the other PIPs'])
    anglesArray.append([2, 1, 4, '100.0',  '70.0', '; Not used in the other PIPs'])
    anglesArray.append([-1, 'Orient Head'])
    anglesArray.append([1, 4, 5, '140.0', '30.0', '; link to lipid'])
    anglesArray.append([4, 5, 6, '120.0', '25.0', '; These are part of the default lipids rules'])
    anglesArray.append([4, 5, 7, '180.0', '25.0', '; These are part of the default lipids rules'])
    ...
    beadArray.append([3, 'P4', 1, lipidName, 'C3 ', 3, 0,    ''])
    beadArray.append([4, 'Qa', 1, lipidName, 'PO4', 4, -1.0, '; Name changed from CP to PO4'])
    beadArray.append([5, 'Qa', 1, lipidName, 'P3 ', 5, -2.0, ''])
    index += 5
    ...
    anglesArray.append([4, 6, 7, '120.0', '25.0', '; These are part of the default lipids rules'])
    anglesArray.append([4, 6, 8, '180.0', '25.0', '; These are part of the default lipids rules'])
    anglesArray.append([2, 1, 4, '140.0', '400.0', '; Used to correct head-tail angle'])
    anglesArray.append([-1, 'Tail part (uses standar Martini v2.0 tail rules)'])

    dihedralsArray.append([-1, '3  1  4  6  1  -30.0  5.0  1 ; Removed as it was unstable - WARNING has not been tested'])
    dihedralsArray.append([5, 2, 3, 1, 1, '-50.0', '8.0   1', '; Used to push the P3 bead to the back of the ring'])
    ...
    beadArray.append([4, 'Qa', 1, lipidName, 'PO4', 4, -1.0, '; Name changed from CP to PO4'])
    beadArray.append([5, 'Qa', 1, lipidName, 'P3 ', 5, -2.0, ''])
    beadArray.append([6, 'Qa', 1, lipidName, 'P4 ', 6, -2.0, ''])
    index += 6
    ...
    bondsArray.append([2, 3, '0.40', '30000', ''])
    bondsArray.append([2, 5, '0.30', '30000', ''])
    bondsArray.append([2, 6, '0.30', '30000', ''])
    bondsArray.append([1, 5, '0.40', '25000', ''])
    bondsArray.append([3, 6, '0.40', '25000', ''])
    bondsArray.append([-2, '#endif'])
    bondsArray.append([-1, '5  6  1  0.60  25000 ; Not needed anymore as the P1-C2-C3-C1 and P2-C2-C1-C3 dihedras were added.'])
    bondsArray.append([1, 4, '0.35', defBforce, ''])
    ...
    anglesArray.append([4, 7, 8, '120.0', '25.0', '; These are part of the default lipids rules'])
    anglesArray.append([4, 7, 9, '180.0', '25.0', '; These are part of the default lipids rules'])
    anglesArray.append([2, 1, 4, '140.0', '400.0', '; Used to correct head-tail angle'])
    anglesArray.append([-1, 'Tail part (uses standar Martini v2.0 tail rules)'])

    dihedralsArray.append([-1, '3  1  4  7  1  -30.0  5.0  1 ; Removed as it was unstable - WARNING has not been tested'])
    dihedralsArray.append([5, 2, 3, 1, 1, '-50.0', '8.0   1',  '; Used to push the P3 bead to the back of the ring'])
    dihedralsArray.append([6, 2, 1, 3, 1, '-50.0', '15.0   1', '; Used to push the P2 bead to the front of the ring'])
    ...
    constraintsArray.append([2, 3, '0.40', ''])
    constraintsArray.append([2, 5, '0.30', ''])
    constraintsArray.append([2, 6, '0.30', ''])
    constraintsArray.append([1, 5, '0.40', ''])
    constraintsArray.append([3, 6, '0.40', ''])
    constraintsArray.append([-2, '#endif'])
    ...
    beadArray.append([5, 'Qa', 1, lipidName, 'P3 ', 5, -2.0, ''])
    beadArray.append([6, 'Qa', 1, lipidName, 'P4 ', 6, -2.0, ''])
    beadArray.append([7, 'Qa', 1, lipidName, 'P5 ', 7, -2.0, ''])
    index += 7
    ...
    bondsArray.append([1, 3, '0.40', '30000', ''])
    bondsArray.append([2, 3, '0.40', '30000', ''])
    bondsArray.append([1, 5, '0.40', '25000', '; C1-P3'])
    bondsArray.append([2, 5, '0.30', '30000', '; C2-P3'])
    bondsArray.append([2, 6, '0.40', '30000', '; C2-P4'])
    bondsArray.append([3, 6, '0.40', '25000', '; C3-P4'])
    bondsArray.append([2, 7, '0.40', '25000', '; C2-P5'])
    bondsArray.append([3, 7, '0.30', '30000', '; C3-P5'])
    bondsArray.append([-2, '#endif'])
    bondsArray.append([-1, '5  6 	1 	0.60 	25000 	; Not needed anymore as P1-C2-C3-C1 and P2-C2-C1-C3 dihedrals are defined.'])
    bondsArray.append([-1, '6  7 	1 	0.60 	25000 	; Not needed anymore as P2-C2-C1-C3 and P3-C2-C1-C3 dihedrals are defined.'])
    bondsArray.append([1, 4, '0.35', defBforce, ''])
    ...
    anglesArray.append([4, 8, 9, '120.0', '25.0', '; These are part of the default lipids rules'])
    anglesArray.append([4, 8, 10, '180.0', '25.0', '; These are part of the default lipids rules'])
    anglesArray.append([2, 1, 4, '140.0', '400.0', '; Used to correct head-tail angle'])
    anglesArray.append([-1, 'Tail part (uses standar Martini v2.0 tail rules)'])

    dihedralsArray.append([-1, '3  1  4  8  1  -30.0  5.0  1 ; Removed as it was unstable - WARNING has not been tested'])
    dihedralsArray.append([5, 2, 3, 1, 1, '-50.0', '10.0   1',  '; Used to push the P3 bead to the back respect to the ring (as in POP1, POP2 & POP7)'])
    dihedralsArray.append([6, 2, 1, 3, 1, '-60.0', '10.0   1', '; Used to push the P4 bead to the front respect to the ring (as in POP4, POP4, & POP6)'])
    dihedralsArray.append([7, 2, 1, 3, 1, '180.0', '120.0   1', '; Used to keep the P5 bead planar respect to the ring (as in POP5, POP6 & POP7).'])
    ...
    constraintsArray.append([2, 6, '0.30', ''])
    constraintsArray.append([3, 6, '0.40', ''])
    constraintsArray.append([2, 7, '0.40', ''])
    constraintsArray.append([3, 7, '0.30', ''])
    constraintsArray.append([-2, '#endif'])
    ...
    beadArray.append([3, 'P4', 1, lipidName, 'C3 ', 3, 0,    ''])
    beadArray.append([4, 'Qa', 1, lipidName, 'PO4', 4, -1.0, '; Name changed from CP to PO4'])
    beadArray.append([5, 'Qa', 1, lipidName, 'P4 ', 5, -2.0, ''])
    index += 5
    lCharge += -3.0 # Keep track of overall lipid charge
    beadArray.append([-1, 'Tail part (uses standar Martini v2.0 tail rules)'])
    ...
    bondsArray.append([1, 3, '0.40', '30000', ''])
    bondsArray.append([2, 3, '0.40', '30000', ''])
    bondsArray.append([3, 5, '0.40', '25000', ''])
    bondsArray.append([2, 5, '0.30', '30000', ''])
    bondsArray.append([-2, '#endif'])
    bondsArray.append([1, 4, '0.35', defBforce, ''])
    bondsArray.append([4, 6, defBlength, defBforce, ''])  # This links the head to the linker
    ...
    dihedralsArray.append([-1, '3  1  4  6  1  -30.0  5.0  1 ; Removed as it was unstable - WARNING has not been tested'])
    dihedralsArray.append([5, 2, 1, 3, 1, '-50.0', '8.0   1', '; Used to push P4 bead to the front of the ring (as in POP6 & POP2).'])
    ...
    constraintsArray.append([1, 3, '0.40', ''])
    constraintsArray.append([2, 3, '0.40', ''])
    constraintsArray.append([3, 5, '0.40', ''])
    constraintsArray.append([2, 5, '0.30', ''])
    constraintsArray.append([-2, '#endif'])
    ...
    beadArray.append([3, 'P4', 1, lipidName, 'C3 ', 3, 0,    ''])
    beadArray.append([4, 'Qa', 1, lipidName, 'PO4', 4, -1.0, '; Name changed from CP to PO4'])
    beadArray.append([5, 'Qa', 1, lipidName, 'P5 ', 5, -2.0, ''])
    index += 5
    lCharge += -3.0 # Keep track of overall lipid charge
    beadArray.append([-1, 'Tail part (uses standar Martini v2.0 tail rules)'])
    ...
    bondsArray.append([1, 3, '0.40', '30000', ''])
    bondsArray.append([2, 3, '0.40', '30000', ''])
    bondsArray.append([2, 5, '0.40', '25000', ''])
    bondsArray.append([3, 5, '0.30', '30000', ''])
    bondsArray.append([-2, '#endif'])
    bondsArray.append([1, 4, '0.35', defBforce, ''])
    bondsArray.append([4, 6, defBlength, defBforce, ''])  # This links the head to the linker
    bondsArray.append([-1, 'Tail part (uses standar Martini v2.0 tail rules)'])
    ...
    dihedralsArray.append([-1, '3  1  4  6  1  -30.0  5.0  1 ; Removed as it was unstable - WARNING has not been tested'])
    dihedralsArray.append([5, 2, 1, 3, 1, '180', '100.0   1', '; Used to keep the P5 bead planar respect to the ring (as in POP6 & POP7)'])
    ...
    constraintsArray.append([1, 3, '0.40', ''])
    constraintsArray.append([2, 3, '0.40', ''])
    constraintsArray.append([2, 5, '0.40', ''])
    constraintsArray.append([3, 5, '0.30', ''])
    constraintsArray.append([-2, '#endif'])
    ...
    beadArray.append([4, 'Qa', 1, lipidName, 'PO4', 4, -1.0, '; Name changed from CP to PO4'])
    beadArray.append([5, 'Qa', 1, lipidName, 'P4 ', 5, -2.0, ''])
    beadArray.append([6, 'Qa', 1, lipidName, 'P5 ', 6, -2.0, ''])
    index += 6
    lCharge += -5.0 # Keep track of overall lipid charge
    beadArray.append([-1, 'Tail part (uses standar Martini v2.0 tail rules)'])
    ...
    bondsArray.append([1, 3, '0.40', '30000', ''])
    bondsArray.append([2, 3, '0.40', '30000', ''])
    bondsArray.append([3, 5, '0.40', '25000', '; C3-P4'])
    bondsArray.append([3, 6, '0.30', '30000', '; C3-P5'])
    bondsArray.append([2, 6, '0.40', '25000', '; C2-P5'])
    bondsArray.append([2, 5, '0.30', '30000', '; C2-P4'])
    bondsArray.append([-2, '#endif'])
    bondsArray.append([-1, '5  6  1  0.60  25000 ; Not needed anymore as the P1-C2-C3-C1 and P2-C2-C1-C3 dihedras were added.'])
    bondsArray.append([1, 4, '0.35', defBforce, ''])
    bondsArray.append([4, 7, defBlength, defBforce, ''])  # This links the head to the linker
    ...
    dihedralsArray.append([-1, '3  1  4  7  1  -30.0  5.0  1 ; Removed as it was unstable - WARNING has not been tested'])
    dihedralsArray.append([5, 1, 2, 3, 1, '50.0', '12.0   1',  '; Used to push P4 bead to the front of the ring (as in POP4).'])
    dihedralsArray.append([6, 2, 1, 3, 1, '180.0', '100.0   1', '; Used to keep P5 bead planar respect to the ring (as in POP5).'])
    ...
    constraintsArray.append([2, 3, '0.40', ''])
    constraintsArray.append([3, 5, '0.40', ''])
    constraintsArray.append([3, 6, '0.30', ''])
    constraintsArray.append([2, 6, '0.40', ''])
    constraintsArray.append([2, 5, '0.30', ''])
    constraintsArray.append([-2, '#endif'])
    ...
    dihedralsArray.append([-1, '3  1  4  7  1  -30.0  5.0  1 ; Removed as it was unstable - WARNING has not been tested'])
    dihedralsArray.append([5, 2, 3, 1, 1, '-50.0', '10.0   1', '; Used to push P3 to the back (as in POP1) respect to the ring.'])
    dihedralsArray.append([6, 3, 1, 2, 1, '180.0', '50.0   1', '; Used to keep P5 planar (as in POP5) respect to the ring.'])
    ...
    anglesArray.append([2, 1, 4, ' 60.0', defAforce2, ''])
    anglesArray.append([2, 1, 3, '130.0', defAforce2, ''])
    anglesArray.append([3, 1, 4, '130.0', defAforce2, ''])
